        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <Link href="/" className="hover:opacity-80 transition-opacity flex-shrink-0">
                        <img src="/assets/logo.png" alt="RealVibe" className="h-12 md:h-14 w-auto" />
                    </Link>
                    ...
                    <Link
                        href="/contact"
                        className="hidden md:inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-purple-800 to-pink-700 hover:from-purple-700 hover:to-pink-600 transition-all duration-300 hover:scale-[1.03] hover:shadow-lg hover:shadow-purple-900/30"
                    >
                        Get Started
            ...
            >
                ...
                <div className="mt-4 pt-4 border-t border-white/10">
                    <Link
                        href="/contact"
                        className="block text-center px-6 py-3 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-purple-800 to-pink-700 hover:from-purple-700 hover:to-pink-600 transition-all"
                    >
                        Get Started &rarr;
                    </Link>
                </div>
